...
<b>游记管理</b></h2>
   ...
   <form name="form1" id="form1"  class="form-horizontal" method="post" action="<%=path %>/youjiUpdate?id=${youji.id}">		<div class="form-group">
		<label for="title" class="col-sm-2 control-label">标题</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="title" id="title"class="form-control" required="required" value="${youji.title}" >  		  </div>
		</div>
		<div class="form-group">
		<label for="username" class="col-sm-2 control-label">上传用户</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="username" id="username"class="form-control" required="required" value="${youji.username}" >  		  </div>
		</div>
		<div class="form-group">
		<label for="shijian" class="col-sm-2 control-label">时间</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="shijian" id="shijian"class="form-control" required="required" value="${youji.shijian}" >  		  </div>
		</div>
       ...
       <script type="text/javascript" src="<%=path %>/ueditor/ueditor.all.js"></script>
		...
		<label for="neirong" class="col-sm-2 control-label">内容</label>
 		 <div class="col-sm-2">
 <textarea name="neirong" id="neirong" >${youji.neirong}</textarea>
<script type="text/javascript">
...
initialFrameHeight:200,initialFrameWidth:540})   </script>
  ...
  <div class="form-inline row" style="padding-left:10px;">
		<label for="pic" class="col-sm-2 control-label">图片</label>
 		 <div class="col-sm-4">
 		 <input type="text" name="pic" id="pic "size="30"  required="required" value="${youji.pic}" >  		  <input type="button" value="上传" onclick="up()"  class="btn  btn-success" />  		  </div>
		</div>
		</div>
		<div class="form-group">
		<label for="dianji" class="col-sm-2 control-label">点击量</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="dianji" id="dianji"class="form-control" required="required" value="${youji.dianji}" >  		  </div>
		</div>
		<div class="form-group">
