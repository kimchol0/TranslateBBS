...
<br>
  ...
  <form name="form1" class="form-horizontal" id="form1" method="post" action="<%=path %>/userAdd">		<div class="form-group">
		...
		<label for="xingming" class="col-sm-2 control-label">姓名</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="xingming" id="xingming"class="form-control" required="required">  		  </div>
		</div>
		<div class="form-group">
       ...
       <option value="女">女</option>
		...
		<label for="tel" class="col-sm-2 control-label">电话</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="tel" id="tel"class="form-control" required="required">  		  </div>
		</div>
		<div class="form-group">
		<label for="address" class="col-sm-2 control-label">地址</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="address" id="address"class="form-control" required="required">  		  </div>
		</div>
		...
		<label for="touxing" class="col-sm-2 control-label">头像</label>
 		 <div class="col-sm-4">
 		 <input type="text" name="touxing" id="touxing" size="30" class="form-control"/>
