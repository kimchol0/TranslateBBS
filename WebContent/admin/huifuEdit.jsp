...
<br>
  ...
  <form name="form1" id="form1"  class="form-horizontal" method="post" action="<%=path %>/huifuUpdate?id=${huifu.id}">		<div class="form-group">
		<label for="username" class="col-sm-2 control-label">用户名</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="username" id="username"class="form-control" required="required" value="${huifu.username}" >  		  </div>
		</div>
		<div class="form-group">
		<label for="tid" class="col-sm-2 control-label">帖子编号</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="tid" id="tid"class="form-control" required="required" value="${huifu.tid}" >  		  </div>
		</div>
		<div class="form-group">
		<label for="shijian" class="col-sm-2 control-label">回复时间</label>
 		 <div class="col-sm-2">
 		 <input type="text" name="shijian" id="shijian"class="form-control" required="required" value="${huifu.shijian}" >  		  </div>
		</div>
       ...
       <script type="text/javascript" src="<%=path %>/ueditor/ueditor.all.js"></script>
		...
		<label for="neirong" class="col-sm-2 control-label">内容</label>
 		 <div class="col-sm-2">
 <textarea name="neirong" id="neirong" >${huifu.neirong}</textarea>
